...
class Trainer(object):
    ...
    def train(self):
        # Dataloader
        train_loader, valid_loader = get_train_validation_loader(self.config.batch_size,
                                                                 self.config.way, self.config.valid_trials,
    ...
    def test(self):
        ...
        test_loader = get_test_loader(self.config.way, self.config.test_trials,
